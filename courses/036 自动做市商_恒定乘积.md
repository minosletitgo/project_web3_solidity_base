...
contract CPAMM {
        ...
        returns (uint256 shares)
    {
        /*
            ...
            - 说明：使用代币数量，指向流动性价值，使用"开根号"的原因是，因为"开根号"可以更好的表达线性，如果去掉"开根号"，那么流动性的表达就是抛物线。
            ...
            => shares = ......(详细推导过程，见037)
            => shares = totalSupply x △𝑥 / 𝑥
            => shares = totalSupply x △𝑦 / 𝑦
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        /*
            - 基础数据介绍
            L = √(𝑥 x 𝑦)                            = "开根号"，代表当前流动性池子的价值         (单位：流动性份额)
            △L = √(△𝑥 x △𝑦)                       = "开根号"，代表添加最终返还流动性池子的价值    (单位：流动性份额)
            shares                                  = 需要为用户增加的"流动性份额"               (单位：流动性份额)
            totalSupply                             = 总流动性份额                              (单位：流动性份额)            
        */
