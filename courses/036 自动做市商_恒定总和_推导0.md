...
contract CSAMM {
        ...
        returns (uint256 amountOut)
    {
        ...
        */
        ...
        /*
            ...
            => △𝑦 = △𝑥 x (99.7%)
            => △𝑦 = △𝑥 x 997 / 1000
            => _amountOut = _amountIn x 997 / 1000
        */            
        ...
        returns (uint256 shares)
    {
        /*
            ...
            - 基础数据介绍
            (△𝑥 + △𝑦)   = 用户带来新增的代币总数        (单位：代币数量)
            (𝑥 + 𝑦)     = 合约的代币储备总量            (单位：代币数量)            
            shares      = 需要为用户增加的"流动性份额"   (单位：流动性份额)
            totalSupply = 总流动性份额                  (单位：流动性份额)

            - 使用"增量比例"公式推演，遵循同一单位做比例
            => (𝑥 + 𝑦) / ((𝑥 + 𝑦) + (△𝑥 + △𝑦)) = totalSupply / (totalSupply + shares)
            => shares = (△𝑥 + △𝑦) x totalSupply / (𝑥 + 𝑦)
        */
        ...
        returns (uint256 d0, uint256 d1)
    {
        /*
            - 基础数据介绍
            (△𝑥 + △𝑦)   = 用户带来减去的代币总数        (单位：代币数量)
            (𝑥 + 𝑦)     = 合约的代币储备总量            (单位：代币数量)            
            shares      = 需要为用户减去的"流动性份额"   (单位：流动性份额)
            totalSupply = 总流动性份额                  (单位：流动性份额)

            - 使用"减量比例"公式推演，遵循同一单位做比例
            => (𝑥 + 𝑦) / ((𝑥 + 𝑦) - (△𝑥 + △𝑦)) = totalSupply / (totalSupply - shares)
            => (△𝑥 + △𝑦) = (𝑥 + 𝑦) x shares / totalSupply
            => △𝑥 = 𝑥 x shares / totalSupply
            => △𝑦 = 𝑦 x shares / totalSupply
        */
